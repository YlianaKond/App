            ...
            <div className="card shadow">
              <div className="card-body p-5">
                ...
                <div className="alert alert-info">
                  <h6 className="alert-heading"><i className="bi bi-info-circle me-2"></i>Информация о фотографиях:</h6>
                ...
                <form>
                  ...
                  <div className="mb-3">
                    ...
                    <textarea className="form-control" id="pet-description" name="description" rows="4" required></textarea>
                  </div>
                  ...
                  <div className="d-grid">
                    <button type="submit" className="btn btn-primary btn-lg">
                      <i className="bi bi-cloud-upload me-2"></i>Добавить объявление
                    </button>
                  </div>
                </form>
              </div>
